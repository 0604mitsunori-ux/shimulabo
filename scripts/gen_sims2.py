...
SIMS.append(dict(id='mental-age', cat='人生・自分ごと', emoji='🧠',
  ...
  article='''    <h2>精神年齢とおじさん・おばさん度</h2>
    <p>普段の何気ない振る舞いには、実年齢とは別の「心の年齢」がにじみます。メッセージの句読点、絵文字の使い方、新しいものへの反応、休日の過ごし方……こうした小さな習慣から精神年齢と「おじさん・おばさん度」を推定するお遊び診断です（結果に深い意味はありません）。</p>
    <h2>精神年齢のタイプ</h2>
    <table class="seo-table"><tr><th>精神年齢</th><th>タイプ</th></tr>
    <tr><td>〜24歳</td><td>永遠の若者タイプ</td></tr>
    <tr><td>25〜37歳</td><td>等身大タイプ</td></tr>
    <tr><td>38〜51歳</td><td>ちょい大人タイプ</td></tr>
    <tr><td>52歳〜</td><td>達観・老成タイプ</td></tr></table>
    <p>「おじさん・おばさん化」は年齢そのものより、習慣や気持ちの持ちようで進みます。もっと詳しくセルフチェックしたい方は、次の診断もどうぞ。</p>
    <ul>
    <li><a href="/sims/ojisan-do/">おじさん度診断</a>……10のあるあるでおじさん度を％診断</li>
    <li><a href="/sims/obasan-do/">おばさん度診断</a>……10のあるあるでおばさん度を％診断</li>
    <li><a href="/sims/wakamono-do/">若者度（Z世代度）診断</a>……イマドキ度を％診断</li>
    </ul>
    <h2>よくある質問</h2>''' + faq([('当たっていますか？','あくまでエンタメ診断です。当たっても当たらなくても、笑って楽しんでください。'),('精神年齢を若く保つには？','新しいことに触れる・姿勢を正す・口ぐせを見直すだけでも印象は変わります。おじさん度診断も参考にどうぞ。'),('データは送信されますか？','いいえ。診断はすべてブラウザ内で完結します。')]),
  js='''  function calc(){

...
SIMS = [
    ...
    ("unmei",              "運命の人に出会う確率",                 "💘", "人生・自分ごと", "人口と条件から運命の人候補と出会う確率を試算。"),
    ...
    ("konkatsu-match",     "婚活マッチ診断",                       "💍", "人生・自分ごと", "年齢と条件から釣り合いやすい相手像と出会い方を試算（点数化しない）。"),
    ("konkatsu-jouken",    "婚活 条件マッチ診断",                  "💕", "人生・自分ごと", "理想の条件を満たす人数と、条件を緩めると候補が何倍になるかを試算。"),
    ("konkatsu-type",      "婚活 相性タイプ診断",                  "🫶", "人生・自分ごと", "5つの質問で価値観タイプと相性の良い相手・婚活法を診断。"),
]

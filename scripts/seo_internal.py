...
SIMS = [
    ...
    ("galaxy-collision",   "銀河衝突シミュレーター",               "🌌", "ふしぎ・現象",   "4,000個の星の重力計算で銀河衝突と潮汐の尾を体感。"),
    ("black-hole",         "ブラックホール 光の曲がり",            "🕳️", "ふしぎ・現象",   "光の束がねじ曲がり、巻き付き、吸い込まれる。指で狙って撃てる。"),
    ("shinka-sim",         "進化シミュレーター",                   "🧬", "ふしぎ・現象",   "食べて増えて突然変異。自然選択で速さが勝手に進化していく。"),
    ("hinan-crowd",        "群衆避難シミュレーター",               "🚪", "ふしぎ・現象",   "焦るほど遅くなる？130人の避難タイムを実測する実験室。"),
    ("element-sandbox",    "粉と水のサンドボックス",               "🏖️", "ふしぎ・現象",   "砂・水・火・草を指で描いて遊ぶ落下砂の物理箱庭。"),

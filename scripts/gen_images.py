...
SIMS = [
    ...
    ("galaxy-collision",   "銀河衝突シミュレーター",                   "ふしぎ・現象"),
    ("black-hole",         "ブラックホール 光の曲がり",                "ふしぎ・現象"),
    ("shinka-sim",         "進化シミュレーター",                       "ふしぎ・現象"),
    ("hinan-crowd",        "群衆避難シミュレーター",                   "ふしぎ・現象"),
    ("element-sandbox",    "粉と水のサンドボックス",                   "ふしぎ・現象"),
